...
class Runner:
    ...
    def _generate_traj_eval(self,env,actor, deterministic=True):
        ...
        for t in range(self.T):
            ...
            s, r, terminated, truncated, _ = env.step(actor.clip(a))
    ...
    def _generate_traj(self,env,actor, deterministic=False):
        """Generates single trajectory."""
        s_traj = []
        s_raw_traj = []
        a_traj = []
